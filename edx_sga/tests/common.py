...
class TempfileMixin(unittest.TestCase):
    ...
    def set_up_temp_directory(cls):
        ...
        cls._original_file_storage = settings.STORAGES['default']
        cls.temp_directory = mkdtemp()
        settings.MEDIA_ROOT = cls.temp_directory
        settings.STORAGES['default'] = "django.core.files.storage.FileSystemStorage"
    ...
    def tear_down_temp_directory(cls):
        ...
        settings.STORAGES['default'] = cls._original_file_storage
